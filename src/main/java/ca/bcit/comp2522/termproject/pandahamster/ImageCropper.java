...
public final class ImageCropper {
     ...
     * @param imgPath the path of the original image, starting at the root of the resources directory
    ...
    public static WritableImage cropImage(final String imgPath, final int x, final int y, final int width, final int height) {
        Image originalImage = new Image(HelloApplication.class.getResource(imgPath).getPath());
